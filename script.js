...
const colors = {
  color1: { current: "#068e06", new: "#11e711" },
  color2: { current: "#950303", new: "#fd2a2a" },
  color3: { current: "#01018a", new: "#2062fc" },
  color4: { current: "#919102", new: "#fafa18" },
};
...
colorPart.forEach((element) => {
  element.addEventListener("click", async (e) => {
    if (pathGeneratorBool) return false;
